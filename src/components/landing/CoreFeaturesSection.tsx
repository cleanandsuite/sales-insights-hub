...
const features = [
  {
    ...
    description:
      "After every call with key prospects, capture quick reflections linked to deal stages and next steps. The system generates concise summaries highlighting strengths and gaps.",
  },
  {
    icon: Brain,
  ...
  },
  {
    ...
    description:
      "Compare call summaries across regions and roles. See how tone, pacing, and listening affect conversion rates over time.",
  },
  {
    icon: Users,
    title: "Team Insights",
    description:
      "Tie conversation quality directly to deals closed. Point to concrete shifts in close rates and cycle time tied to specific AI coaching behaviors.",
  },
  {
    icon: BarChart2,
    title: "Behavior Libraries",
    description:
      "Reusable assets for sales calls, QBRs, and steering committees. Pull examples of strong value narratives and objection handling from top performers.",
  },
  {
    icon: Shield,
    title: "Privacy & Governance",
    description:
      "Data encryption, tight access controls, and clear terms respecting both company policies and individual privacy during AI coaching sessions.",
  },
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6">
            Core Features For The <span className="text-primary"> Ai Coaching Program & Sales Calls</span>
          </h2>
