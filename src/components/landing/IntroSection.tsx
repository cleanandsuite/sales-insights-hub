      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground">
            Why Your Sales Conversations and calls <span className="gradient-text">AI Coaching</span>
          </h2>
          ...
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
            ...
            fades once people return to real pressure.
          </p>

          <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto">
            This is exactly where AI coaching transforms sales calls. Instead of sporadic meetings, equip every team
            member with continuous, data-based guidance that adapts to their role and current pipeline—delivering
            stronger performance and measurable business outcomes.
          </p>
        </div>
