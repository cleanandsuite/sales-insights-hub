...
export function IntroSection() {
  return <section className="py-20 md:py-28 bg-section-aurora relative overflow-hidden">
...
 AI Coaching<span className="gradient-text">AI Coaching</span>
          ...
          <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto">This is exactly where AI-driven guidance, where ai coaches operate in real time, thransforms customer calls. Instead of sporadic meetings, equip every team member with continuous, data-based guidance that adapts to their role and current pipeline—delivering stronger performance and measurable business outcomes.</p>
        </div>
        ...
        }].map(item => <div key={item.label} className="flex flex-col items-center gap-3 p-6 rounded-2xl bg-card/80 backdrop-blur-sm border border-border/50 hover:shadow-xl hover:border-primary/30 transition-all duration-300 glass-card-subtle">
