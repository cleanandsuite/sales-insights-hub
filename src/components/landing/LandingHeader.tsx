      ...
      <div className="container mx-auto px-4">
        <nav className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-3 hover:opacity-90 transition-opacity">
            <div className="h-9 w-9 rounded-lg bg-white/10 flex items-center justify-center overflow-hidden backdrop-blur-sm">
              <img src={sellsigLogo} alt="SellSig" className="h-6 w-6 object-contain" />
            </div>
            <span className="font-bold text-xl text-white">SellSig</span>
          </Link>
