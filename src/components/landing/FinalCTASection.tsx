      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">
            Ready to Transform Your <span className="text-accent">Sales Performance?</span>
          </h2>
          <p className="text-lg md:text-xl text-white/90 max-w-xl mx-auto">
            Join forward-thinking sales teams who are already using AI sales tools to close more deals, improve
            forecasting accuracy, and drive measurable revenue growth.
          </p>
          <div className="pt-4">
            <Button
              size="lg"
            ...
            <p className="text-sm text-white/80 mt-4">
              14-day free trial • Credit card required • Full access to all features
            </p>
          </div>
