      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6">
            How AI Coaching Elevates <span className="gradient-text">Sales Call Quality</span>
          </h2>
          <p className="text-lg text-muted-foreground">
            Revenue leaders ask how the system improves what happens across customer calls. Our platform delivers
            insights you'd struggle to see manually, turning every interaction into a catalyst for growth and a
            repeatable guide for the next a sales call.
          </p>
        </div>
