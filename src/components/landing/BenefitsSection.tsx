      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Revenue leaders ask how the system improves what happens across sales calls. 
            Our platform delivers insights you'd struggle to see manually, turning every 
            interaction into a catalyst for growth.
          </p>
        </div>
