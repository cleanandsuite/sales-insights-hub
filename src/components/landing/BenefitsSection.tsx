...
const benefits = [{
  ...
  description: "Before high-stakes meetings, short prompts help prepare for objections and clarify outcomes. Afterward, leaders debrief sales calls in minutes while interactions are still fresh.",
  gradient: "from-success/20 to-success/5"
}, {
  icon: TrendingUp,
  title: "Quality Standards",
  description: 'Define what "good" looks like for discovery, demos, and pricing discussions. Link those standards to observation tools and AI insights across all sales calls.',
...
  Sales Call Quality<span className="gradient-text">Sales Call Quality</span>
          </h2>
          <p className="text-lg text-muted-foreground">Revenue leaders ask how the system improves what happens across sales calls. Our platform delivers insights you'd struggle to see manually, turning every interaction into a catalyst for growth and a clear example of a sales call done well.</p>
        </div>
