        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground">
              Across sales and sales call{" "}
              <span className="text-primary">Intelligent Revenue Guidance Sales Conversations</span>
            </h2>

            <p className="text-lg text-muted-foreground leading-relaxed">
              Our AI coaching platform combines human expertise and responsible AI to deliver programs that align with
              your strategy. Leaders experience an integrated journey linking goals, team metrics, and day-to-day
              customer interactions.
            </p>

            <p className="text-base text-muted-foreground leading-relaxed">
              At the core sits the AI coach that engages leaders in short, targeted dialogues. The design draws on
              proven models, behavioral science, and real case data from thousands of sales calls. Leaders explore
              scenarios, rehearse conversations, and stress-test decisions in a confidential, always-available
              environment.
            </p>

            <p className="text-base text-muted-foreground leading-relaxed">
              To keep the experience deeply human, each senior leader is paired with an executive coach who focuses on
              context, accountability, and deeper mindset work—blending the reach of AI coaching with the nuance only
              experienced coaches provide.
            </p>
          </div>
          ...
          <div className="relative">
            <div className="bg-card/80 backdrop-blur-xl rounded-3xl border border-border/50 p-8 shadow-2xl glass-card">
              <div className="text-center mb-8">
                ...
                <p className="text-sm text-muted-foreground mt-2">Continuous analysis of your sales calls</p>
              </div>
