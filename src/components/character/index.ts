...
export type { SpriteConfig, AnimatedSpriteProps } from './AnimatedSprite';
export { StationaryCharacter } from './StationaryCharacter';
export type { StationaryCharacterProps } from './StationaryCharacter';
