...
export function SellSigLogo({
  ...
  const logoContent = (
    <div className={cn("flex items-center gap-4.5 hover:opacity-90 transition-opacity group", className)}>
      <div
        className={cn(
      ...
      <div className="flex flex-col">
        ...
        {showTagline && (
          <span
            className={cn("font-medium tracking-widest uppercase leading-none mt-0.5", sizes.tagline, colors.tagline)}
          >
            AI Coach
          </span>
        )}
